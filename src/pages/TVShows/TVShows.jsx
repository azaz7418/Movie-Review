...
const TVShows = () => {
  const { data: popularShows, isLoading: popularLoading, isError: popularError, error: popularErrorData } = useQuery({
    queryKey: ["popularTVShows"],
    queryFn: () => getPopularTVShows(),
  });

  const { data: topRatedShows, isLoading: topRatedLoading, isError: topRatedError, error: topRatedErrorData } = useQuery({
