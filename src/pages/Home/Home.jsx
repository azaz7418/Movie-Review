    ...
    <div className="min-h-screen bg-gradient-to-b from-primary-dark/95 to-primary">
      <div className="container mx-auto pt-24 px-4">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-16">
            {renderContentSection("Popular TV Shows", popularTVShows, "tv", "/tv/popular")}
            {renderContentSection("Top Rated TV Shows", topRatedTVShows, "tv", "/tv/top-rated")}
            {renderContentSection("Airing Today", airingTodayShows, "tv", "/tv/airing-today")}
            {renderContentSection("On The Air", onTheAirTVShows, "tv", "/tv/on-the-air")}
          </div>
        </div>
      </div>
    </div>
